...
namespace TTS
{
	...
	public interface IAPIObject
	{
		...
		[OperationContract]
		bool AddOrder(string ticker, decimal volume, decimal price, int dir, int type);
		[OperationContract]
		void CancelOrder(int id);
		[OperationContract]
		void CancelOrderExpr(string expr);
		[OperationContract]
		int AddQueuedOrder(string ticker, decimal volume, decimal price, int dir, int type);
		[OperationContract]
